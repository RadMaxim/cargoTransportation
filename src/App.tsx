...
function App() {
  ...
  return (
    <>
    <Button type='button' isIcon='calculate' text='Рассчитать стоимость' h={63} w={343} color={"btn1"}/>
    <Button type='button' text='Заказать' h={50} w={99} color={"btn1"}/>
    <Button type='button' text='Заказать' h={50} w={99} color={"btn1"} />
    <Button type='button' text='Показать все' h={50} w={343} color={"btn2"}/>
    <Button type='button' isIcon='calculate' text='Рассчитать стоимость' h={60} w={343} color={"btn1"}/>
    <Button type='button' isIcon='phone' text='Перезвоните мне' h={60} w={343} color={"btn1"}/>
    ...
    <Button type='button' isIcon='calculate' text='Заказать консультацию' h={50} w={344} color={"btn1"}/>
